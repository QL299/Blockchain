...
class PoABlock(Block):
    ...
    def mine(self):
        ...
        new = SigningKey.from_string(self.get_private_key()).sign(self.unsealed_header().encode('UTF-8'))
        new_int = int.from_bytes(new, byteorder = 'big')
        self.set_seal_data(new_int)
